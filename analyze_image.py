...
def analyze_image_with_vertex(image_uri: str, prompt_type: str):
    ...
    if prompt_type == "default":
        ...
        Dopo aver completato le prime due sezioni, scrivi una trascrizione PAROLA PER PAROLA dell'immagine.

        * NON scrivere i titoli delle sezioni, scrivi solo i contenuti dell'analisi
        """
    elif prompt_type == "tim":
        prompt = """
        Voglio che tu agisca come un esperto di media e marketing:
        Fornisci una descrizione dettagliata della pubblicità, includendo tutte le informazioni rilevanti e le dichiarazioni importanti delle persone presenti nello spot.
        Dopo aver descritto dettagliatamente la pubblicità, compila una lista formattata come segue:
        Inserzionista: nome
        Dettagli del piano: (ad es. 100 Giga, 300 minuti)
        Offerta economica: euro
        Leve di marketing: sconti/incentivi/deal
        Awareness: quante volte ripete il nome del prodotto
        Tone of Voice: ...
        Soggetto: Prodotto/Istituzionale
        Call to action: ...
        Target desiderato: ...

        Dopo aver completato le prime due sezioni, scrivi una trascrizione PAROLA PER PAROLA.

        * NON scrivere i titoli delle sezioni, scrivi solo i contenuti dell'analisi
        """
    elif prompt_type == "gara_desa":
        prompt = """
        Sei un esperto di marketing/advertising e lavori in un centro media. Voglio tu faccia un’analisi approfondita sulla pubblicità rappresentata nell'immagine allegata. Sappi che il mercato di riferimento è quello dei detergenti per la casa/detergenti per bucato/prodotti per cura della persona. Inizia fornendomi una descrizione dettagliata dello spot, includendo nome del prodotto (se presente). Sviluppa la tua analisi in modo da evidenziare le seguenti aree:
        ...
        * NON scrivere i titoli delle sezioni, scrivi solo i contenuti dell'analisi
        ...
        prompt = """
        Sei un esperto di marketing/advertising e lavori in un centro media. Voglio tu faccia un’analisi approfondita sulla pubblicità rappresentata nell'immagine allegata. Sappi che il mercato di riferimento è quello del pet food, in particolare per cani e gatti. Inizia fornendomi una descrizione dettagliata dello spot, includendo nome del prodotto (se presente). Sviluppa la tua analisi in modo da evidenziare le seguenti aree:
    ...
    image_file = Part.from_uri(image_uri, mime_type="image/jpeg")
